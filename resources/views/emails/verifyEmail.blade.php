...
<head>
    ...
    <style type="text/css" media="all">
        ...
        .button--yellow {
            ...
            border-top: 10px solid #faae2b;
            border-right: 18px solid #faae2b;
            border-bottom: 10px solid #faae2b;
            border-left: 18px solid #faae2b;
        }
        .button--red {
...
<!-- https://github.com/wildbit/postmark-templates as adapted from -->
